...
import_de =Dict(  "AL" => 0.0, "AO" => 0.0, "AT" => 12.0, "AZ" => 0.0, "BA" => 0.0, "BE" => 10.0, 
...
export_DE = Dict("AL" => 0.0, "AO" => 0.0, "AT" => 0.0, "AZ" => 0.0, "BA" => 0.0, "BE" => 6.543, 
    "BG" => 0.0, "CH" => 0.0, "CM" => 0.0, "CY" => 0.0, "CZ" => 0.0, "DE" => 0.0, 
    "DK" => 0.003610, "DZ" => 0.0, "EE" => 0.0, "EG" => 0.0, "ES" => 0.104589, 
    "FI" => 0.0, "FR" => 0.0, "GB" => 0.0, "GR" => 0.0, "GQ" => 0.0, "HR" => 0.0, 
    "HU" => 0.0, "IE" => 0.0, "IT" => 0.0, "LI" => 0.0, "LT" => 0.0, "LU" => 0.0, 
    "LV" => 0.0, "ME" => 0.0, "MK" => 0.0, "MT" => 0.0, "NG" => 0.0, "NL" => 10.15, 
    "NO" => 0.0, "NotSpec" => 0.0, "OM" => 0.0, "PL" => 0.025106, "PT" => 0.0, 
    "QA" => 0.0, "RO" => 0.0, "RS" => 0.0, "RU" => 0.0, "SE" => 0.0, "SI" => 0.0, 
    "SK" => 0.0, "TR" => 0.0, "TT" => 0.0, "UK" => 0.0, "US" => 0.0, "XX" => 0.0)
